...
public class Main {
    ...
    public static int[] heroesHealth = {270, 260, 250, 280, 700, 250, 260, 280};
        ...
        for (int i = 0; i < heroesHealth.length; i++) {
            if (heroesHealth[i] > 0) {
                if (heroesHealth[4] > 0) {
                    ...
                    playersNumber++;
                    heroesHealth[i] = heroesHealth[i] - (bossDamage - golemDefence);
                    heroesHealth[4] = heroesHealth[4] - bossDamage - (golemDefence * playersNumber);
                }
